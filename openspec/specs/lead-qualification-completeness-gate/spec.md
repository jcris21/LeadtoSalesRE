...
Defines the completeness threshold used by `CompletenessGate` and
`BuyerProfileCaptureService` to decide when a `BuyerProfile` has enough
captured dimensions to advance a lead from Qualification to Recommendation.
